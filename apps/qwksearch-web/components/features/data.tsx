...
export const COMPARISON_ROWS: ComparisonRow[] = [
  ...
  },
  {
    ...
    cells: [
      ...
      { status: "no" },
      { status: "no" },
      { status: "yes", note: "Docker" },
      { status: "yes", note: "Docker" },
      { status: "yes", note: "Docker or Kubernetes" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "no", note: "Fixed model, not user-selectable" },
      { status: "yes", note: "Any Ollama or OpenAI-compatible model" },
      { status: "yes", note: "OpenAI, Anthropic, Ollama, LM Studio & more" },
      { status: "yes", note: "OpenAI, Anthropic, Gemini, local via Ollama" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "no" },
      { status: "yes", note: "Your keys, self-hosted" },
      { status: "yes", note: "Your keys, self-hosted" },
      { status: "yes", note: "Your keys, self-hosted" },
    ],
  },
  ...
  },
  {
    ...
    cells: [
      ...
      { status: "no" },
      { status: "no" },
      { status: "partial", note: "Choose a provider, not per-engine" },
      { status: "no" },
      { status: "yes", note: "Configurable connectors per source" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "no" },
      { status: "no" },
      { status: "no", note: "Shows sources, no formatted citations" },
      { status: "no", note: "Shows sources, no formatted citations" },
      { status: "partial", note: "Inline source links, no APA formatting" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "partial", note: "PDF & file Q&A, no YouTube" },
      { status: "partial", note: "PDF & document upload via RAG" },
      { status: "yes", note: "PDF, DOCX & more via built-in RAG" },
      { status: "yes", note: "Broad document connector support" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "no" },
      { status: "no" },
      { status: "yes", note: "Notion's own rich-text editor" },
      { status: "no" },
      { status: "no" },
      { status: "no" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "no" },
      { status: "yes", note: "Custom system prompts & model presets" },
      { status: "yes", note: "Custom system prompt per workspace" },
      { status: "yes", note: "Configurable assistant prompts" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "no" },
      { status: "no" },
      { status: "yes", note: "Tools & MCP-style function calling" },
      { status: "yes", note: "MCP server support" },
      { status: "partial", note: "Native connectors, MCP in progress" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "no" },
      { status: "no" },
      { status: "partial", note: "Custom tools, no persistent memory" },
      { status: "yes", note: "Workspace memory & agent skills" },
      { status: "partial", note: "Chat history, no long-term memory" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "no" },
      { status: "no" },
      { status: "yes", note: "Notion workspace itself" },
      { status: "no" },
      { status: "partial", note: "S3 & local vector store" },
      { status: "yes", note: "Google Drive, Confluence, Slack & more" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "no" },
      { status: "no" },
      { status: "yes", note: "Built-in TTS/STT" },
      { status: "partial", note: "Via browser or plugin" },
      { status: "no" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "no" },
      { status: "no" },
      { status: "partial", note: "Web clipper only" },
      { status: "no" },
      { status: "no" },
      { status: "no" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "yes", note: "Yes" },
      { status: "no" },
      { status: "yes", note: "Electron desktop app" },
      { status: "no" },
    ],
  },
  {
  ...
  },
  {
    ...
    cells: [
      ...
      { status: "partial", note: "Limited" },
      { status: "yes", note: "Fully self-hosted, no external logging" },
      { status: "yes", note: "Fully self-hosted, no external logging" },
      { status: "yes", note: "Fully self-hosted, no external logging" },
    ],
  },
  {
    ...
    cells: [
      ...
      { status: "paid", note: "Freemium, AI add-on subscription" },
      { status: "yes", note: "Free & open-source" },
      { status: "yes", note: "Free & open-source, paid cloud tier" },
      { status: "yes", note: "Free & open-source, paid cloud tier" },
    ],
  },
];
