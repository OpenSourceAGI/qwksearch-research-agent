/**
 * Shared factory helpers and button definitions used to assemble the editor's bubble menus. Centralizes common actions (alignment, sizing, deletion) reused across the bubble components.
 */
