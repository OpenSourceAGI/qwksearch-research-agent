/**
 * Floating bubble menu shown when a menu drag handle element is selected in the editor. Presents contextual formatting and actions inline near the selection.
 */
