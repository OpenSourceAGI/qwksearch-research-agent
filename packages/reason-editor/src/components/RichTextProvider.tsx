/**
 * React context provider that wraps the editor with tooltip, event-bus, theming, and reset-CSS setup. This is the top-level shell every editor instance mounts inside.
 */
