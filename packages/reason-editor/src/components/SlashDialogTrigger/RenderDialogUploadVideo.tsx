/**
 * Modal dialog for uploading or linking a video, opened via the slash/insert flow. Handles file selection, URL entry, and inserting the video into the editor.
 */
