/**
 * Reusable toggle button UI primitive (shadcn/Radix style) styled with the editor's Tailwind classes. Shared across the editor for consistent toggle button rendering.
 */
