/**
 * SVG icon component for the “GIfIcon” glyph used in the editor's toolbar and menus. Encapsulates the vector markup so the icon scales and inherits the current theme color.
 */

export function GifIcon() {
  return (
    <svg height='1em' viewBox='0 0 15 15' width='1em' xmlns='http://www.w3.org/2000/svg'>
