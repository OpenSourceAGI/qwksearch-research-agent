/**
 * SVG icon component for the “IconColorFill” glyph used in the editor's toolbar and menus. Encapsulates the vector markup so the icon scales and inherits the current theme color.
 */
...
export function IconColorFill({ fill }: IconCProps) {
  return (
    <svg
      height='18px'
      version='1.1'
