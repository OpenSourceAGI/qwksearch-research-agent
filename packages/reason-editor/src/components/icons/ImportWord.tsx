/**
 * SVG icon component for the “ImportWord” glyph used in the editor's toolbar and menus. Encapsulates the vector markup so the icon scales and inherits the current theme color.
 */
