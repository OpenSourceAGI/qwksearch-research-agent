/**
 * Provides the editor-instance hooks (e.g. `useTiptapEditor`) for accessing the active Tiptap editor. Lets components work with an explicitly passed editor or fall back to the one from context.
 */
