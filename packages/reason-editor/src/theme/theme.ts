/**
 * Defines the editor's light/dark theme color palettes and the reactive theme signal and hooks. Drives runtime theming so the UI can switch colors and border radius on the fly.
 */
