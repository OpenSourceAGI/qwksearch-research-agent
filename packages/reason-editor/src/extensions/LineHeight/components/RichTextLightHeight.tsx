/**
 * Toolbar control (React) for the LineHeight extension, which adds line-height/spacing control. Renders the button and dispatches the matching editor command when activated.
 */
