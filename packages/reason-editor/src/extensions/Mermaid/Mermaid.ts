/**
 * Defines the Mermaid Tiptap extension, which adds Mermaid diagrams to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
