/**
 * Defines the Table Tiptap extension, which adds tables to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
