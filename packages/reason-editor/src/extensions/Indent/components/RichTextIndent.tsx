/**
 * Toolbar control (React) for the Indent extension, which adds block indenting and outdenting. Renders the button and dispatches the matching editor command when activated.
 */
