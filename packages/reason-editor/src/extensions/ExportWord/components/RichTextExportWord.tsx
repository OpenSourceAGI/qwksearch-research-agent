/**
 * Toolbar control (React) for the ExportWord extension, which adds exporting the document to a Word (.docx) file. Renders the button and dispatches the matching editor command when activated.
 */
