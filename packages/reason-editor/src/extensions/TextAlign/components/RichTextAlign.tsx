/**
 * Toolbar control (React) for the TextAlign extension, which adds text alignment. Renders the button and dispatches the matching editor command when activated.
 */
