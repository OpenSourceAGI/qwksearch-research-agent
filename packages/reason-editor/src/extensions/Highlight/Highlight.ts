/**
 * Defines the Highlight Tiptap extension, which adds text highlighting to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
...
export const Highlight =
   TiptapHighlight.extend<HighlightOptions>({
    addStorage() {
      return {
