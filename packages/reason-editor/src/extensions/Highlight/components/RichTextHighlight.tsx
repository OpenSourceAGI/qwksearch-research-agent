/**
 * Toolbar control (React) for the Highlight extension, which adds text highlighting. Renders the button and dispatches the matching editor command when activated.
 */
