/**
 * Toolbar control (React) for the Drawer extension, which adds hand-drawn sketch/drawing blocks (easydrawer). Renders the button and dispatches the matching editor command when activated.
 */
