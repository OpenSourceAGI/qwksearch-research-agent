/**
 * Supporting UI component for the Drawer extension (hand-drawn sketch/drawing blocks (easydrawer)). Provides part of the in-editor interface for this feature.
 */
...
export function MdiSquareOutline(props: SVGProps<SVGSVGElement>) {
  return (
    <svg height='1em' viewBox='0 0 24 24' width='1em' xmlns='http://www.w3.org/2000/svg' {...props}>
      <path d='M3 3h18v18H3zm2 2v14h14V5z' fill='currentColor'></path>
    </svg>
  );
}
...
export function MaterialSymbolsRectangleOutline(props: SVGProps<SVGSVGElement>) {
  return (
    <svg height='1em' viewBox='0 0 24 24' width='1em' xmlns='http://www.w3.org/2000/svg' {...props}>
      <path d='M2 20V4h20v16zm2-2h16V6H4zm0 0V6z' fill='currentColor'></path>
    </svg>
  );
}
...
export function GardenUploadStroke12(props: SVGProps<SVGSVGElement>) {
  return (
    <svg height='1em' viewBox='0 0 12 12' width='1em' xmlns='http://www.w3.org/2000/svg' {...props}>
      <path
  ...
  return (
    <svg height='1em' viewBox='0 0 24 24' width='1em' xmlns='http://www.w3.org/2000/svg' {...props}>
      <g fill='none' stroke='currentColor' strokeLinecap='round' strokeWidth='1.5'>
        ...
        <path d='M18.707 15v5' strokeMiterlimit='10'></path>
