/**
 * React node view for the Drawer extension (hand-drawn sketch/drawing blocks (easydrawer)). Renders the interactive in-document UI that Tiptap mounts in place of the node.
 */
