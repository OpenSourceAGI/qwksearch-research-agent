/**
 * Defines the Drawer Tiptap extension, which adds hand-drawn sketch/drawing blocks (easydrawer) to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
