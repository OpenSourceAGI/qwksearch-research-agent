/**
 * Toolbar control (React) for the TextUnderline extension, which adds underline text formatting. Renders the button and dispatches the matching editor command when activated.
 */
