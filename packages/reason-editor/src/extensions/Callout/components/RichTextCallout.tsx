/**
 * Toolbar control (React) for the Callout extension, which adds highlighted callout/admonition blocks. Renders the button and dispatches the matching editor command when activated.
 */
