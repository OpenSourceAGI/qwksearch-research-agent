/**
 * Defines the Callout Tiptap extension, which adds highlighted callout/admonition blocks to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
