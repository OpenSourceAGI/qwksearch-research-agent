/**
 * Defines the History Tiptap extension, which adds undo/redo history to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
...
export const History =  UndoRedo.extend<HistoryOptions>({
  //@ts-expect-error
  addOptions() {
    return {
      ...this.parent?.(),
