/**
 * Toolbar control (React) for the Column extension, which adds multi-column layouts. Renders the button and dispatches the matching editor command when activated.
 */
