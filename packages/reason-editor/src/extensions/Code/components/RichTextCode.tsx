/**
 * Toolbar control (React) for the Code extension, which adds inline code formatting. Renders the button and dispatches the matching editor command when activated.
 */
