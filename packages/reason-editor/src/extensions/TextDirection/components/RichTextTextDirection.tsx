/**
 * Toolbar control (React) for the TextDirection extension, which adds text direction (LTR/RTL). Renders the button and dispatches the matching editor command when activated.
 */
