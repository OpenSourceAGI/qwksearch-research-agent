/**
 * Defines the TextDirection Tiptap extension, which adds text direction (LTR/RTL) to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
