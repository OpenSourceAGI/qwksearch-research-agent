/**
 * Toolbar control (React) for the Italic extension, which adds italic text formatting. Renders the button and dispatches the matching editor command when activated.
 */
