/**
 * Defines the Attachment Tiptap extension, which adds file attachments embedded in the document to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
