/**
 * Toolbar control (React) for the Attachment extension, which adds file attachments embedded in the document. Renders the button and dispatches the matching editor command when activated.
 */
