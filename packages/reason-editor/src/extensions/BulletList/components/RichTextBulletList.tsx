/**
 * Toolbar control (React) for the BulletList extension, which adds unordered (bullet) lists. Renders the button and dispatches the matching editor command when activated.
 */
