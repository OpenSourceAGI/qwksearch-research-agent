/**
 * Defines the HorizontalRule Tiptap extension, which adds horizontal-rule dividers to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
