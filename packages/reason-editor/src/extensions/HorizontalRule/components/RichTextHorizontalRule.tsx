/**
 * Toolbar control (React) for the HorizontalRule extension, which adds horizontal-rule dividers. Renders the button and dispatches the matching editor command when activated.
 */
