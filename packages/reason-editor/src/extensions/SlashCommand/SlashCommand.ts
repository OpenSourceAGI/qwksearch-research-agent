/**
 * Defines the SlashCommand Tiptap extension, which adds the “/” slash-command menu to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
...
export const SlashCommand =  Extension.create<any>({
