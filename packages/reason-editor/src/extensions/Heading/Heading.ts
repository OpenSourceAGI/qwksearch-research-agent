/**
 * Defines the Heading Tiptap extension, which adds headings (h1–h6) to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
