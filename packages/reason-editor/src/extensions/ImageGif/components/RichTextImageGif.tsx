/**
 * Toolbar control (React) for the ImageGif extension, which adds animated GIF images (via Giphy). Renders the button and dispatches the matching editor command when activated.
 */
