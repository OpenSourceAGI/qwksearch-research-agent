/**
 * Toolbar control (React) for the Blockquote extension, which adds blockquote formatting. Renders the button and dispatches the matching editor command when activated.
 */
