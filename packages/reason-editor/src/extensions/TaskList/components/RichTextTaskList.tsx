/**
 * Toolbar control (React) for the TaskList extension, which adds task/checklist lists. Renders the button and dispatches the matching editor command when activated.
 */
