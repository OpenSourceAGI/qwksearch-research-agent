/**
 * Defines the TaskList Tiptap extension, which adds task/checklist lists to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
