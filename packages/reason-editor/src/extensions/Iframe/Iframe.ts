/**
 * Defines the Iframe Tiptap extension, which adds embedding external content via iframes to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
