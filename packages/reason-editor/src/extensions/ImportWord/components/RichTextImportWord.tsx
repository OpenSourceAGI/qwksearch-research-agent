/**
 * Toolbar control (React) for the ImportWord extension, which adds importing Word (.docx) documents. Renders the button and dispatches the matching editor command when activated.
 */
