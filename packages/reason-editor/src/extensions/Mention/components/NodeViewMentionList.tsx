/**
 * React node view for the Mention extension (@-mentions). Renders the interactive in-document UI that Tiptap mounts in place of the node.
 */
...
export const NodeViewMentionList: React.FC<IProps> = forwardRef((props, ref) => {
  ...
  return (
    <div
      className={
        '!richtext-max-h-[320px] !richtext-w-[160px] richtext-overflow-y-auto richtext-overflow-x-hidden richtext-rounded-md !richtext-border !richtext-border-solid !richtext-border-border richtext-bg-popover richtext-p-1 richtext-text-popover-foreground richtext-shadow-md richtext-outline-none'
      }
