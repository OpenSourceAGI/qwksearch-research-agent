/**
 * Toolbar control (React) for the MoreMark extension, which adds additional inline marks (superscript, subscript, and more). Renders the button and dispatches the matching editor command when activated.
 */
