/**
 * Hook that tracks whether a mark or node is currently active and whether its button should be disabled. Keeps toolbar buttons in sync with the current selection state.
 */
