/**
 * Hook that subscribes to a node/mark's attributes on the editor and returns them reactively. Re-renders a component only when the watched attributes actually change.
 */
