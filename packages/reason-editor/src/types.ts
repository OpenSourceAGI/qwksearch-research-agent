/**
 * Central TypeScript type and interface definitions shared across the editor (change events, extension keys, button props, and more). Provides the common contracts that components and extensions depend on.
 */
