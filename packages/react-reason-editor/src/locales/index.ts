/**
 * Localization entry point that registers all language bundles and exposes the `useLocale` hook and locale actions. Central module for switching and consuming the editor's translations.
 */
...
export { en, hu_HU, vi, zh_CN, pt_BR, fi, ja, fa };
