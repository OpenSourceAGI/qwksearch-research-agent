/**
 * SVG icon component for the “IconHighlightFill” glyph used in the editor's toolbar and menus. Encapsulates the vector markup so the icon scales and inherits the current theme color.
 */

export function IconHighlightFill({ fill }: { fill?: string }) {
  return (
    <svg
      height='18px'
      version='1.1'
