/**
 * Modal dialog for uploading or linking an image, opened via the slash/insert flow. Handles file selection, URL entry, and inserting the image into the editor.
 */
