/**
 * Reusable text input UI primitive (shadcn/Radix style) styled with the editor's Tailwind classes. Shared across the editor for consistent text input rendering.
 */
