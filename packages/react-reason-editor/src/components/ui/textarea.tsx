/**
 * Reusable multi-line text input UI primitive (shadcn/Radix style) styled with the editor's Tailwind classes. Shared across the editor for consistent multi-line text input rendering.
 */
