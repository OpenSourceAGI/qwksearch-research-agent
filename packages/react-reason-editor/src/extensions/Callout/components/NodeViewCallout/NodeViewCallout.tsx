/**
 * React node view for the Callout extension (highlighted callout/admonition blocks). Renders the interactive in-document UI that Tiptap mounts in place of the node.
 */
