/**
 * React node view for the Attachment extension (file attachments embedded in the document). Renders the interactive in-document UI that Tiptap mounts in place of the node.
 */
