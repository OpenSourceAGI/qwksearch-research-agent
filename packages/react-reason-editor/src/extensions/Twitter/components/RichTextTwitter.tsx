/**
 * Toolbar control (React) for the Twitter extension, which adds embedded tweets. Renders the button and dispatches the matching editor command when activated.
 */
