/**
 * Defines the ImageGif Tiptap extension, which adds animated GIF images (via Giphy) to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
