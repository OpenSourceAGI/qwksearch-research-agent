/**
 * Defines the Indent Tiptap extension, which adds block indenting and outdenting to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
