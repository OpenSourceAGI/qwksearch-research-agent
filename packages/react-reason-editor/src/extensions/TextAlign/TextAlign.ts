/**
 * Defines the TextAlign Tiptap extension, which adds text alignment to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
...
export const TextAlign =
   TiptapTextAlign.extend<TextAlignOptions>({
    //@ts-expect-error
    addOptions() {
      return {
        ...this.parent?.(),
