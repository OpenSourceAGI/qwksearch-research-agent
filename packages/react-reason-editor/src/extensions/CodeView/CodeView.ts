/**
 * Defines the CodeView Tiptap extension, which adds viewing and editing the document's raw HTML source to the editor. It sets up the extension's schema, commands, and default options so the feature integrates with the editor.
 */
...
export const CodeView =  Extension.create<CodeViewOptions>({
  name: 'codeView',
  //@ts-expect-error
  addOptions() {
    return {
