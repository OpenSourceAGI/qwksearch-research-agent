/**
 * @fileoverview Detects and corrects common English typos in free-form text (e.g. search
 * queries, titles, prompts) using a static dictionary of ~8k known misspellings. URLs,
