...
export const LANGUAGE_MODELS = [
  ...
  },
  {
    ...
    models: [
      {
        name: "Llama 3.3 70B (Free - Default)",
        id: "meta-llama/llama-3.3-70b-instruct:free",
        contextLength: 131072,
        free: true,
        type: "text-generation",
        rateLimit: "No daily limit - Best for general chat, reasoning, complex queries",
        description: "Meta's latest, best for general chat and complex queries",
      },
      {
        ...
        free: true,
        type: "text-generation",
        rateLimit: "No daily limit - Best for technical content, coding",
        description: "NVIDIA's model, excellent for technical content and coding assistance",
      },
      {
